...
public class Main {
  ...
  public static void main(String[] args) {
    Hamburger myBurger = new Hamburger("Basic", "steak", "Dutch crunch");
    double price = myBurger.itemizeHamburger();
    System.out.println(price);

    HealthyBurger healthyBurger = new HealthyBurger("Steak");

    double healthyBurgerPrice = healthyBurger.itemizeHamburger();

    System.out.println(healthyBurgerPrice);

    healthyBurger.addHamburgerAddition1("lettuce", .50);
